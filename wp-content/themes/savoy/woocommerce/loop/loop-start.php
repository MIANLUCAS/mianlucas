...
$is_variable_grid = ( $is_shop_catalog && $nm_theme_options['shop_grid'] !== 'default' ) ? true : false;
...
if ( isset( $nm_globals['is_categories_shortcode'] ) ) { // Note: $nm_globals['is_categories_shortcode'] is unset in "../woocommerce/loop/loop-end.php"
    ...
    $grid_class = ( $is_variable_grid ) ? 'grid-variable ' . $nm_theme_options['shop_grid'] : 'grid-default';
