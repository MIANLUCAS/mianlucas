		...
		'fields'	=> array(
            ...
            array(
				...
				'options'	=> array(
                    ...
                    'grid-6n-1-5' => array( 'title' => 'Variable<br>(3 columns)', 'img' => NM_URI . '/assets/img/option-panel/shop-grid-6n-1-5.png' ),
					'grid-10n-1-7' => array( 'title' => 'Variable<br>(4 columns)', 'img' => NM_URI . '/assets/img/option-panel/shop-grid-10n-1-7.png' )
				),
				'default' 	=> 'default'
			),
			array(
