 ...
 */
function nm_wishlist_get_header_link() {
    global $nm_theme_options;
    ...
    if ( isset( $nm_theme_options ) ) {
        ...
        $link_title = ( $nm_theme_options['menu_wishlist_icon'] ) ? $nm_theme_options['menu_wishlist_icon_html'] : esc_html__( 'Wishlist', 'nm-wishlist' );
        
        return '<a href="' . esc_url( $link_href ) . '">' . $link_title . '</a>';
    }
