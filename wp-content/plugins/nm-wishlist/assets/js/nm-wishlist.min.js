...
[],{expires:a.cookieExpires})}},IDsUpdate:function(){var a=this;if(a.isLoggedIn){var d=JSON.stringify(a.wishlistIds);a.IDsUpdateAjax=c.ajax({type:"POST",url:nm_wp_vars.ajaxUrl,data:{action:"nm_wishlist_update_ids",ids:d},dataType:"json",cache:!1,headers:{"cache-control":"no-cache"},complete:function(){a.IDsUpdateAjax=!1}})}Cookies.set("nm-wishlist-ids",a.wishlistIds,{expires:a.cookieExpires})},buttonsSetState:function(){for(var a=0;a<this.wishlistIds.length;a++)c("#nm-wishlist-item-"+this.wishlistIds[a]+
...
(this.wishlistIds.splice(b,1),d=!1);this.IDsUpdate();this.buttonSetState(a,d)},wishlistItemRemove:function(a,d){c("#nm-wishlist-overlay").addClass("show");var b=this,f=a.closest("ul"),e=f.data("product-id");f.addClass("removing");e=c.inArray(e,b.wishlistIds);-1!=e&&b.wishlistIds.splice(e,1);b.IDsUpdate();setTimeout(function(){f.remove();b.$body.trigger("wishlist_removed_item");0==d.children("ul").length&&(c("#nm-wishlist").css("display","none"),c("#nm-wishlist-empty").addClass("show"));c("#nm-wishlist-overlay").removeClass("show")},
500)}};c(document).ready(function(){g.init()})})(jQuery);