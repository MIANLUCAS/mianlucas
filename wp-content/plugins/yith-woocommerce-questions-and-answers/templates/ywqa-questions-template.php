			...
			if ( $item_shown < $count ) : ?>
				<div id="show-all-questions">
					<a class="show-questions" href="<?php echo add_query_arg( "show-all-questions", yit_get_prop($product, 'id') ); ?>"
					   title="<?php echo sprintf( esc_html__( "Show all %d questions with answers", 'yith-woocommerce-questions-and-answers' ), $count ); ?>"><?php echo sprintf( esc_html__( "Show all %d questions with answers", 'yith-woocommerce-questions-and-answers' ), $count ); ?></a>
				</div>
			<?php endif; ?>
