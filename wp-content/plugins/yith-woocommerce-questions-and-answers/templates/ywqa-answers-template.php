...
<div id="new-answer-header">
	<div id="parent-question">
		...
		<div
			class="question-owner"><?php echo sprintf( esc_html__( "asked by %s on %s", 'yith-woocommerce-questions-and-answers' ), '<span class="question-author-name">' . $question->get_author_name() . '</span>',
...
<div id="ywqa_answer_list">
	...
	<?php if ( $question_count = $question->has_answers() ) : ?>
		<span
			class="answer-list-count"><?php echo sprintf( esc_html__( "%s answers shown", 'yith-woocommerce-questions-and-answers' ), $question_count ); ?></span>
