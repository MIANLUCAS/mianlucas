...
<li id="li-answer-<?php echo $answer->ID; ?>" class="answer-container <?php echo $classes; ?>">
	...
	<div
		class="answer-owner"><?php echo sprintf( esc_html__("%s answered on %s", 'yith-woocommerce-questions-and-answers'), '<span class="answer-author-name">' . $answer->get_author_name() . '</span>',
