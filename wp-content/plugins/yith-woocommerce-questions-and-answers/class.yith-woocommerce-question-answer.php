...
if ( ! class_exists ( 'YITH_WooCommerce_Question_Answer' ) ) {
	...
	class YITH_WooCommerce_Question_Answer {
		...
		public function enqueue_styles_scripts() {
			...
			wp_enqueue_script ( "ywqa-frontend", YITH_YWQA_URL . 'assets/js/ywqa-frontend.js', array( 'jquery' ),false,true );
			
			wp_enqueue_style ( 'ywqa-frontend', YITH_YWQA_ASSETS_URL . '/css/ywqa-frontend.css' );

            wp_localize_script ( 'ywqa-frontend', 'ywqa_frontend', array(
                'reply_to_question'   => isset($_GET['reply-to-question']) ? $_GET['reply-to-question'] : null,
            ) );
