...
class ECOMMERCE_NOTIFICATION_Admin_Settings {
	...
	public function save_meta_boxes() {
		...
		if ( $pagenow === 'admin.php' && isset( $_REQUEST['page'] ) && $_REQUEST['page'] === 'ecommerce-notification' ) {
			...
			$data = $_POST['ecommerce_notification_params'];
        ...
        <div class="wrap ecommerce-notification">
            ...
            <form method="post" action="" class="vi-ui form">
                ...
                <div class="vi-ui attached tabular menu">
                    ...
                    <div class="item"
                         data-tab="products"><?php esc_html_e( 'Products', 'ecommerce-notification' ) ?></div>
                    <div class="item"
                         data-tab="product-detail"><?php esc_html_e( 'Product Detail', 'ecommerce-notification' ) ?></div>
                    ...
                    <div class="item"
                         data-tab="short-code"><?php esc_html_e( 'Short code', 'ecommerce-notification' ) ?></div>
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
								...
								?>
                                <select name="<?php echo self::set_field( 'post_type' ) ?>"
                        ...
                        <tr valign="top" class="detect_address">
                            ...
                            <td>
                                <input type="text" name="<?php echo self::set_field( 'ipfind_auth_key' ) ?>"
                                       value="<?php echo self::get_field( 'ipfind_auth_key', '' ) ?>"/>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo self::set_field( 'non_ajax' ) ?>"><?php esc_html_e( 'Non Ajax', 'ecommerce-notification' ) ?></label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                    ...
                    <table class="optiontable form-table">
                            ...
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo self::set_field( 'loop' ) ?>"
                                           ...
                                           class="hidden" value="1" name="<?php echo self::set_field( 'loop' ) ?>"/>
                                    <label></label>
                                </div>
                            </td>
                        </tr>
                        <tr valign="top" class="hidden time_loop">
                            ...
                            <td>
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number" name="<?php echo self::set_field( 'next_time' ) ?>"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number" name="<?php echo self::set_field( 'initial_delay' ) ?>"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input id="<?php echo self::set_field( 'custom_shortcode' ) ?>" type="text" tabindex="0"
                                       value="<?php echo self::get_field( 'custom_shortcode', esc_attr( '{number} people seeing this product right now' ) ) ?>"
