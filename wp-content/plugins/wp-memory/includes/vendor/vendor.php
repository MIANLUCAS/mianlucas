...
<div style="display:none; max-width:530px !important;">
  ...
  <a href="#TB_inline?&width=530&height=240&inlineId=wpmemory-scan-id<?php echo $is_modal; ?>" id="wpmemory-scan-ok" class="thickbox" style="display:none;">xx---xxx</a>
  ...
  <div class="bill-parent">
    <div class="bill-child-cols" style="margin-top:5px;">
      <video id="bill-banner-wpm" style="margin: 0px; padding:0px;" width="400" height="240" muted>
        <source src="<?php echo WPMEMORYURL; ?>assets/videos/memory4.mp4" type="video/mp4">
      </video>
