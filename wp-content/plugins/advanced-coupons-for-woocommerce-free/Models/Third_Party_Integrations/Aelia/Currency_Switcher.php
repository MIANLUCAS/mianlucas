...
use ACFWF\Models\Advanced_Coupon;
...
class Currency_Switcher implements Model_Interface {
    ...
    */
    ...
    public function convert_amount_to_user_selected_currency( $amount , $is_reverse = false ) {
        ...
        if ( $is_reverse )
            return $this->aelia_obj()->convert( $amount , $user_currency , $site_currency ); // convert from user to base.
        else
            return $this->aelia_obj()->convert( $amount , $site_currency , $user_currency ); // convert from base to user.
    }
    ...
    */
    ...
    public function run() {
        ...
        if ( ! $this->_helper_functions->is_plugin_active( 'woocommerce-aelia-currencyswitcher/woocommerce-aelia-currencyswitcher.php' ) ) return;
