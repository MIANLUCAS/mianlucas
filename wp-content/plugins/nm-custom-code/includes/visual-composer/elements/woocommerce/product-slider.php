<?php
	...
	vc_map( array(
		...
		'params' 		=> array(
            ...
            array(
				'type' 			=> 'textfield',
				'heading' 		=> esc_html__( 'Category ID', 'nm-framework-admin' ),
				'param_name' 	=> 'category',
				'description'	=> esc_html__( 'Enter a <a href="https://docs.woocommerce.com/document/find-product-category-ids/" target="_blank">product category ID</a>.', 'nm-framework-admin' ),
				'dependency'	=> array(
					'element'	=> 'shortcode',
