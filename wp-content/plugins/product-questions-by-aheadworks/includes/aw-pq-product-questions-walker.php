	...
	class Aw_Pq_Walker_Comment extends Walker_Comment {
				...
				<div class="comment-body">
					...
					<div id="div-comment-<?php comment_ID(); ?>" class="comment-content">
							...
							<div id="respond-<?php comment_ID(); ?>" class="comment-respond hide_answerform">
								<form action="<?php echo wp_kses(admin_url( 'admin-post.php' ), wp_kses_allowed_html('post')); ?>" method="post" id="commentform" class="comment-form " novalidate="">
									...
									<p class="comment-form-author">
										...
										<input id="author" name="author" type="text" class="author-<?php comment_ID(); ?>" value="<?php echo wp_kses($name, wp_kses_allowed_html('post')); ?>" required="required">
									</p>
									...
									<p class="comment-form-email <?php echo wp_kses($hide_email, wp_kses_allowed_html('post')); ?>">
										...
										<input id="email" name="email" class="email-<?php comment_ID(); ?>" type="email" value="<?php echo wp_kses($email, wp_kses_allowed_html('post')); ?>"  aria-describedby="email-notes" required="required">
									</p>
							...
							<div id="editrespond-<?php comment_ID(); ?>" class="comment-respond comment-editrespond hide_editanswerform">
								<form action="<?php echo wp_kses(admin_url( 'admin-post.php' ), wp_kses_allowed_html('post')); ?>" method="post" id="commentform" class="comment-form" novalidate="">
									...
									<p class="comment-form-author">
										...
										?>
										" value="<?php echo wp_kses($name, wp_kses_allowed_html('post')); ?>" required="required">
									</p>
									...
									<p class="comment-form-email <?php echo wp_kses($hide_email, wp_kses_allowed_html('post')); ?>">
										...
										?>
										" type="email" value="<?php echo wp_kses($email, wp_kses_allowed_html('post')); ?>"  aria-describedby="email-notes" required="required">
									</p>
						...
						<?php 
							...
							?>
							<div id="respond-<?php comment_ID(); ?>" class="comment-respond hide_answerform">
								<p><?php echo wp_kses(aw_pq_translate_text('Please'), wp_kses_allowed_html('post')); ?>, <a href="<?php echo wp_kses(wp_login_url( get_permalink() ), wp_kses_allowed_html('post')); ?>"><?php echo wp_kses(aw_pq_translate_text('log in'), wp_kses_allowed_html('post')); ?></a>&nbsp;<?php echo wp_kses(aw_pq_translate_text('to post an answer'), wp_kses_allowed_html('post')); ?>
								</p>
							</div>
		...
		public static function aw_pq_ask_question_form( $class = 'hide_questionsform') {
			...
			if ( ( '' == get_option('pq_allowtouser') || 'anyone' == get_option('pq_allowtouser') )  || ( 'loggedinuser' == get_option('pq_allowtouser') && is_user_logged_in() ) ) {
				...
				$html = '<div id="respond" class="comment-respond ' . $class . '" >
							<form action="' . admin_url( 'admin-post.php' ) . '" method="post" id="commentform1" class="comment-form" novalidate="">
								...
								<p class="comment-form-author">
									...
									<input id="author" name="author" type="text" value="' . $name . '" class="author-' . $product_id . '" size="30" maxlength="245" required="required">
								</p>
								<p class="comment-form-email ' . $hide_email . '">
									<label for="email">' . aw_pq_translate_text('Email') . '<span class="required">*</span></label>
									<input id="email" name="email" type="email" value="' . $email . '" class="email-' . $product_id . '" size="30" maxlength="100" aria-describedby="email-notes" required="required">
								</p>
								<p>
				...
				$html = '<div id="respond" class="comment-respond ' . $class . '" ><p>' . aw_pq_translate_text('Please') . ', <a href="' . wp_login_url( get_permalink() ) . '">' . aw_pq_translate_text('log in') . '</a>&nbsp;' . aw_pq_translate_text('to post a question') . '</p></div>';
			}
