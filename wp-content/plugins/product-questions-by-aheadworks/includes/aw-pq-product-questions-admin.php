...
View it on the site:',
		...
		<h2>
			...
			<small class="wc-admin-breadcrumb"><a href="<?php echo wp_kses(admin_url(), wp_kses_allowed_html('post')); ?>?page=product-questions&amp;tab=emails" aria-label="Return to emails">⤴</a></small>
		</h2>
