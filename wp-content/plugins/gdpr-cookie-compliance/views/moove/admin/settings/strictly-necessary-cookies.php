...
<div class="gdpr-admin-popup gdpr-admin-popup-fsm-settings" style="display: none;">
	...
	<div class="gdpr-popup-content">
		...
		<div class="gdpr-popup-content-content">
			...
			<p class="description"><strong><?php esc_html_e( 'Please note that Full Screen Mode feature requires the Strictly Necessary Cookies to be always enabled (otherwise the Cookie Banner would be displayed at every visit).', 'gdpr-cookie-compliance-addon' ); ?></strong></p> <br /><br />
					<!--  .description -->

			<a href="<?php echo admin_url( '?page=moove-gdpr&amp;tab=full-screen-mode'); ?>" class="button button-primary button-deactivate-confirm">
