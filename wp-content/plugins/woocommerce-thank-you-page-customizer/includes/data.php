...
class VI_WOOCOMMERCE_THANK_YOU_PAGE_DATA {
	private $params;
	private $default;

	/**
	 * VI_WOOCOMMERCE_THANK_YOU_PAGE_DATA constructor.
	 * Init setting
	 */
	public function __construct() {
		...
		$this->default = array(
			...
			'order_confirmation_order_number_title'  => 'Order number',
			'order_confirmation_date_title'  => 'Date',
			'order_confirmation_order_total_title'  => 'Total',
			'order_confirmation_email_title'  => 'Email',
			'order_confirmation_payment_title'  => 'Payment method',
			...
			'order_details_product_title_text'             => 'Product',
			'order_details_product_value_text'             => 'Total',
			...
			'customer_information_billing_title'             => 'Billing address',
			'customer_information_shipping_title'             => 'Shipping address',
...
Best Regards',
			...
			'bing_map_width'          => 0,
			'bing_map_height'         => '500',
			'bing_map_address'        => '{store_address}',
			'bing_map_label'          => '<h3>This is my store</h3>
{address}',
			'bing_map_zoom_level'     => 14,
			'bing_map_view'           => 'road',
			'bing_map_navbarmode'     => 'default',
			'bing_map_marker'         => 'default',
	...
	public function get_params( $name = "", $language ='' ) {
		...
		return apply_filters('woo_thank_you_page_params' . $name_t, $this->params[$name_t] ?? $this->params[ $name ] ?? false);
	}
	...
	public static function email_template_customizer_active() {
		return ( class_exists( 'WooCommerce_Email_Template_Customizer' ) || class_exists( 'Woo_Email_Template_Customizer' ) );
	}
	public static function get_email_templates( $type = 'wtypc_coupon_email' ) {
		return self::email_template_customizer_active() ? viwec_get_emails_list($type):array();
	}
...
new VI_WOOCOMMERCE_THANK_YOU_PAGE_DATA();
