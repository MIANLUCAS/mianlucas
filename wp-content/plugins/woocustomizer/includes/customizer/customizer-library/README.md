...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'overlay' ), // Required
...
$panels[] = array(
	'id' => $panel,
	'title' => __( 'Panel Examples', 'overlay' ),
	'priority' => '100'
);
...
$sections[] = array(
	'id' => $section,
	'title' => __( 'Panel Section', 'overlay' ),
	'priority' => '10',
	'panel' => $panel
);
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'overlay' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'overlay' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'overlay' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'overlay' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'overlay' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-radio'] = array(
	'id' => 'example-radio',
	'label'   => __( 'Example Radio', 'overlay' ),
	'section' => $section,
	'type'    => 'radio',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-upload'] = array(
	'id' => 'example-upload',
	'label'   => __( 'Example Upload', 'overlay' ),
	'section' => $section,
	'type'    => 'upload',
	'default' => '',
);
...
$options['example-color'] = array(
	'id' => 'example-color',
	'label'   => __( 'Example Color', 'overlay' ),
	'section' => $section,
	'type'    => 'color',
	'default' => $color // hex
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'overlay' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'overlay'),
);
~~~
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'overlay' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
