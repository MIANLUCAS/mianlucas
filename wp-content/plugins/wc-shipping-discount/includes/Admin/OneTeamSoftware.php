...
if (!class_exists('OneTeamSoftware\WooCommerce\Admin\OneTeamSoftware')):
...
class OneTeamSoftware
{
	...
	public function onAdminMenu()
	{
		add_menu_page(
			...
			$this->mainMenuId,
			array(&$this, 'display'),
			plugins_url('assets/images/1TeamSoftware-icon.png', dirname(dirname(__FILE__))),
			26
		);
	...
	public function display()
	{
		...
		<div class="wrap <?php echo $this->mainMenuId; ?>">
			<img width="190" height="80" src="<?php echo plugins_url('assets/images/1TeamSoftware-logo.png', dirname(dirname(__FILE__))); ?>" class="header_logo header-logo" alt="1 Team Software">
			<div class="card">
